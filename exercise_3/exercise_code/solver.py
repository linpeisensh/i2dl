...
class Solver(object):
    ...
    def __init__(self, optim=torch.optim.Adam, optim_args={},
        ...
        optim_args_merged.update(optim_args) #if there is the same key in dict, change values; if not, add
    ...
    def train(self, model, train_loader, val_loader, num_epochs=10, log_nth=0):
        ...
        self._reset_histories()
        iter_per_epoch = len(train_loader) #int(len(train_loader.dataset)/batchsize)+1
